...
<head>
    ...
    <link href="estilosblack.css" rel="stylesheet"/>
...
<div id="main"><figure id="logo">
    ...
    <div id="menu">
        <nav id="menu">
            <ul type="none">
                <li><a href="http://ookamienterprises.com/paradox//love.php?cap=<?php echo $cap;?>&modo=Normal">Modo Normal</a></li>
            </ul>
        </nav>
    </div>
</div>
...
</div> <fieldset id="nav" name="Navegação"><a href="http://ookamienterprises.com/paradox/loven.php<?php echo $backs; ?>" id="nav"><- <?php echo $back; ?></a> | <a href="http://ookamienterprises.com/paradox/loven.php<?php echo $nexts; ?>" id="nav"><?php echo $next; ?> -></a> </fieldset>
</body>
</html>